const QuestionsArray = [
  ...
  `2. Create a functional component named UserCard that accepts the
    ...
    different user data.`,
  `3. Create a functional component named Weather that accepts a
  ...
  `4. Create a functional component named Counter that displays a
  ...
  `5. Create a functional component named TaskList that accepts an
  ...
  `6. Create a functional component named Button that accepts props
